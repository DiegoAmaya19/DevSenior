...
public record BookRequestDTO(
        @NotBlank(message = "El ISBN es obligatorio") @Size(min = 10, max = 13, message = "El ISBN debe tener entre 10 y 13 dígitos") @Pattern(regexp = "^[0-9]{10,13}$", message = "El ISBN debe contener solo números") String isbn,

        @NotBlank(message = "El título es obligatorio") @Size(max = 500, message = "El título no puede exceder 500 caracteres") String title,
        ...
        @Min(value = 1, message = "La calificación mínima es 1") @Max(value = 5, message = "La calificación máxima es 5") Integer rating) {
}
